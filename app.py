...
st.set_page_config(page_title="1-Page Multi-Style Resume Engine", layout="wide")
...
with st.sidebar.expander("3. Core Competencies", expanded=False):
    comp_1 = st.text_input("Category 1", "Technical Support: Tier-1 Troubleshooting, Remote Helpdesk, Hardware/Software Diagnostics")
    comp_2 = st.text_input("Category 2", "Administration: MS Office Suite (Excel, Word, PowerPoint), Data Verification, Order Processing")
    comp_3 = st.text_input("Category 3", "Client Relations: Multi-channel Inquiries (Email/Ticket/Phone), SLA Compliance")
    comp_4 = st.text_input("Category 4", "Languages: English (Fluent), Bahasa Melayu (Fluent)")
